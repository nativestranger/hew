...
little_cats = FactoryBot.create(:piece, user: user, name: 'Little Cats')
...
big_cats = FactoryBot.create(:piece, user: user, name: 'Big Cats')
...
little_dogs = FactoryBot.create(:piece, user: user, name: 'Little Dogs')
...
big_dogs = FactoryBot.create(:piece, user: user, name: 'Big Dogs')
